...
#     @patch("api.routes.agents.check_budget_available")
#     @patch("api.routes.agents.get_agent")
#     def test_non_hex_gig_agent_has_no_budget_header(
...
#         # check_budget_available should not be called for non-hex_gig agents
...
#
#         response = client.post(
#             "/agents/hex_gig_agent/runs", json={"message": "Hello", "stream": False}
#         )
#
...
#
#
# class TestBudgetOnlyAppliesToHexGig:
#     """Tests ensuring budget enforcement only applies to hex_gig agent."""
#
#     @patch("api.routes.agents.check_budget_available")
#     @patch("api.routes.agents.get_agent")
#     def test_budget_only_applies_to_hex_gig_agent(
#         self, mock_get_agent, mock_check, client
#     ):
#         """Budget check should only apply to hex_gig_agent."""
#         # Mock agent to avoid actual LLM calls
#         mock_agent = MagicMock()
#         mock_agent.arun = AsyncMock(return_value=MagicMock(content="Test response"))
#         mock_get_agent.return_value = mock_agent
#
#         # Call a non-hex_gig agent
#         response = client.post(
#             "/agents/c/runs", json={"message": "Hello", "stream": False}
#         )
#
...
#     @patch("api.routes.agents.check_budget_available")
#     @patch("api.routes.agents.get_agent")
#     def test_hex_gig_agent_checks_budget(self, mock_get_agent, mock_check, client):
#         """hex_gig_agent should always check budget availability."""
#         reset_time = datetime.now(ZoneInfo("UTC")) + timedelta(hours=5)
